...
// update GUI to show default values
 ...
 SceneManager.AmbientLight = [0.9, 0.8, 0.8];
 updateDirLight();
...
function updateXShear(){
	ControlManager.cshearx = document.getElementById("xlocalshear").value;
  document.getElementById("xshearlabel").textContent = ControlManager.cshearx;
}

function updateYShear(){
	ControlManager.csheary = document.getElementById("ylocalshear").value;
  document.getElementById("yshearlabel").textContent = ControlManager.csheary;
}
